...
public class RankerStore 
{
    ...
    public RankerStore(String filename) 
    {
    ...
    public void openDBTables()
    {
         ...
         Ranker = crawlerStore.openDatabase(null,"Ranker",dbConfig);
  
    }

   //Start of insert and retrieve from URLId and URL table
    
    public void insertIntoRanker(String URLId,String rank)
    {
    	...
    	try
    	{
	         ...
	         StringBinding.stringToEntry(rank, dataEntry);
	         OperationStatus status = Ranker.put(null, keyEntry, dataEntry);
    ...
    public String retrieveFromRanker(String URLId)
    {
    	boolean enteredCatch = false;
    	try
    	{
	        ...
	        DatabaseEntry dataEntry = new DatabaseEntry();
	        StringBinding.stringToEntry(URLId, keyEntry);
	        Ranker.get(null, keyEntry, dataEntry, null);
    ...
    public static void main(String argv[]) throws IOException
    {
        DatabaseEntry keyEntry = new DatabaseEntry();
        DatabaseEntry dataEntry = new DatabaseEntry();
        RankerStore cs = new RankerStore("/home/cis455/worker/Rama/store");
        cs.openEnv();
        cs.openDBTables();
        Cursor cursor = cs.Ranker.openCursor(null, null);
        int i=0;
        cs.insertIntoRanker("hiiiii", "1");
        cs.insertIntoRanker("byeeee", "2");
        System.out.println(cs.retrieveFromRanker("hiiiii"));
