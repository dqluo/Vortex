...
/*			String text=doc.text(); 
	...
	public  void addURLHostPositions(String text,  String tag){
		...
		while (st3.hasMoreElements()) {
			...
			count++;
			if(!ar.contains(word) && matcher.find() && matcher.group().length()==word.length()){
				if(!word.equals("www")&&!word.equals("http")&&!word.equals("com")&&!word.equals("edu")&&!word.equals("png")&&!word.equals("net")&&!word.equals("org")&& !word.equals("jpg")&&!word.equals("jpeg")&&!word.equals("tiff")&&!word.equals("bmp")&&!word.equals("jiff")&&!word.equals("gif")){
					word=MorphaStemmer.morpha(word, false);
